export default function Banner() {
  return (
    <div className='flex flex-col lg:flex-row lg:space-x-5 justify-between h-30 bg-[#080e10] font-bold px-5 py-5'>
      <div>
        <h1 className='text-center text-5xl text-slate-300'>Dmitry&lsquo;s Blog</h1>
